...
const DOM = { 
    ...
    innerHTMLTransaction(transaction, index) {
        ...
        if (transaction.description.length > 20){
            ...
            <td>
             <img onclick="Transaction.remove(${index})" src="./assets/lixeira2.png" width='34' left='20' alt="remover transação"> </a>
            </td>
            `
        ...
        <td class="date">${transaction.date}</td>
        <td>
        <a href="">  <img onclick="Transaction.remove(${index})" src="./assets/lixeira2.png" width='34' left='20'   alt="remover transação"> </a>
        </td>
        `
        return html
